...
const file_icon = <svg width="1em" height="0.9em" viewBox="0 0 14 16" style={{margin: "0px 25px 0px 15px"}} 
    className="bi bi-file-earmark-text-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
